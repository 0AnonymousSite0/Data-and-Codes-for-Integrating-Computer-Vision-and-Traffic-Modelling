...
class YOLO(object):
    _defaults = {
        "model_path": r'D:\ZHOUSHENGHUA\PycharmProjects\VehicelDetection\model_data\yolo.h5',
        "anchors_path": r'D:\ZHOUSHENGHUA\PycharmProjects\VehicelDetection\model_data\yolo_anchors.txt',
        "classes_path": r'D:\ZHOUSHENGHUA\PycharmProjects\VehicelDetection\model_data\coco_classes.txt',
        "score" : 0.3,
        "iou" : 0.45,
...
#新加的，为了替换老黑的检测器
    def detect_image_2(self, image):
        ...
        _bounding_boxes, _classes, _confidences = self.sess.run(
