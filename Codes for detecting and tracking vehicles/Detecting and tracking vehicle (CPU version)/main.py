...
#cap = cv2.VideoCapture (r'rtsp://strmr5.sha.*****.gov:****/rtplive/****************') #'path of the real-time video signal'
...
tracker = 'csrt' if args.tracker == None else args.tracker

# create detection region of interest polygon
if args.droi == None:
    droi = [(0, 0), (f_width, 0), (f_width, f_height), (0, f_height)]

    #droi =[(0, 45), (329, 45), (331, 180), (1, 180)]#47
    ##droi =[(180, 466), (190, 250), (328, 250), (333, 462)]#50
    #droi =[(2, 478), (263, 325), (322, 326), (323, 478)] #40-1
    #droi = [(330, 478), (330, 410),(450, 315), (540, 314), (602, 477)] #40-2
    #droi=[(339, 318)], [(581, 294)], [(582, 313)], [(337, 410)] #53右侧小路
    #droi=[(409, 95), (525, 92), (590, 245), (336, 247), (337, 204)] #53左侧
    #droi= [(467, 250), (638, 250), (640, 480), (588, 480)]#58
...
if 1:
    ...
    output_video_path='./videos/53101508000815_20200410_track.avi'
